[← 先决条件](/docs/zh-CN/0-Prerequisites.md) | 安装[(English)](/docs/en-US/1-Installation.md) | [客户端 →](/docs/zh-CN/2-Client.md)
***
...
请[下载 .zip 文件](http://aliyunsdk-pages.alicdn.com/php-sdk/client.zip)，然后在项目中的选定位置解压，最后将自动加载工具包含到您的脚本中。
