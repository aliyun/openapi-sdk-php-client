...
namespace AlibabaCloud\Client\Tests\Unit\Client\Regions;
 ...
 *
 * @package      AlibabaCloud\Client\Tests\Unit\Client\Regions
 *
 * @category     AlibabaCloud
 *
 * @author       Alibaba Cloud SDK <sdk-team@alibabacloud.com>
...
class EndpointProviderTest extends TestCase
{
    ...
    public function testNull()
    {
        ...
        // Test
        $null = EndpointProvider::findProductDomain($regionId, $product);
