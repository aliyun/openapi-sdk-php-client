...
namespace AlibabaCloud\Client\Tests\Unit\Client\Profile;
 ...
 *
 * @package      AlibabaCloud\Client\Tests\Unit\Client\Profile
 *
 * @author       Alibaba Cloud SDK <sdk-team@alibabacloud.com>
...
class DefaultProfileTest extends TestCase
{
    ...
    public function testGetRamRoleArnProfile()
    {
        ...
        // Test
        $profile =
            DefaultProfile::getRamRoleArnProfile($regionId, $accessKeyId, $accessKeySecret, $roleArn, $roleSessionName);
