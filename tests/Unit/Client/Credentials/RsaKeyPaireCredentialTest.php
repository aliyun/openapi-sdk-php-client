...
namespace AlibabaCloud\Client\Tests\Unit\Client\Credentials;
 ...
 *
 * @package      AlibabaCloud\Client\Tests\Unit\Client\Credentials
 *
 * @author       Alibaba Cloud SDK <sdk-team@alibabacloud.com>
...
class RsaKeyPaireCredentialTest extends TestCase
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertEquals(\file_get_contents($privateKeyFile), $credential->getPrivateKey());
    }
}
