...
namespace AlibabaCloud\Client\Tests\Functional\Request;
 ...
 *
 * @package AlibabaCloud\Client\Tests\Functional\Request
 *
 * @author    Alibaba Cloud SDK <sdk-team@alibabacloud.com>
 * @copyright 2018 Alibaba Group
 * @license   http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
...
class RoaRequestTest extends TestCase
{
    public function testRoa()
    {
        ...
        try {
            ...
            $result = (new RoaRequest())->uriPattern('/clusters/[ClusterId]/services')
                                        ->method('GET')
                                        ->product('CS')
                                        ->version('2015-12-15')
